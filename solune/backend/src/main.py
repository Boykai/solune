    ...
    **Fallback (no sessions):** When no user sessions exist (e.g. fresh
    ...
    try:
        ...
        for row in rows:
            ...
            except Exception as e:  # noqa: BLE001 — reason: startup/shutdown resilience; logs and continues
                logger.warning(
...
async def _discover_and_register_active_projects() -> int:
    ...
    except Exception:  # noqa: BLE001 — reason: startup/shutdown resilience; logs and continues
...
def create_app() -> FastAPI:
    ...
    async def generic_exception_handler(_request: Request, exc: Exception) -> JSONResponse:
        ...
        try:
            ...
            logger.debug("Sentry capture failed (best-effort)", exc_info=True)
