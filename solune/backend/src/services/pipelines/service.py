...
# Preset pipeline definitions — the ONLY built-in saved pipelines.
_PRESET_DEFINITIONS = [
    # ── GitHub ────────────────────────────────────────────────────────
    {
        "preset_id": "github",
        ...
        "stages": [
            _grouped_stage(
                ...
                0,
                "preset-gh-group-1",
                [_agent("preset-gh-agent-1", "copilot", "GitHub Copilot")],
            ),
        ],
    },
    # ── Spec Kit ──────────────────────────────────────────────────────
    {
        ...
        "stages": [
            _grouped_stage(
                ...
                "preset-sk-group-1",
                [
                    _agent("preset-sk-agent-1", "speckit.specify", "speckit.specify"),
                    _agent("preset-sk-agent-2", "speckit.plan", "speckit.plan"),
                    _agent("preset-sk-agent-3", "speckit.tasks", "speckit.tasks"),
                    _agent("preset-sk-agent-4", "speckit.analyze", "speckit.analyze"),
                    _agent("preset-sk-agent-5", "speckit.implement", "speckit.implement"),
                ],
            ),
        ],
    },
    # ── Default ───────────────────────────────────────────────────────
    {
        "preset_id": "default",
        "name": "Default",
        "description": "Spec Kit workflow plus quality assurance, testing, linting, and review agents",
        "stages": [
            _grouped_stage(
                "preset-def-stage-1",
                "In progress",
                ...
                "preset-def-group-1",
                [
                    _agent("preset-def-agent-1", "speckit.specify", "speckit.specify"),
                    _agent("preset-def-agent-2", "speckit.plan", "speckit.plan"),
                    _agent("preset-def-agent-3", "speckit.tasks", "speckit.tasks"),
                    _agent("preset-def-agent-4", "speckit.analyze", "speckit.analyze"),
                    _agent("preset-def-agent-5", "speckit.implement", "speckit.implement"),
                    _agent("preset-def-agent-6", "quality-assurance", "Quality Assurance"),
                    _agent("preset-def-agent-7", "tester", "Tester"),
                    _agent("preset-def-agent-8", "linter", "Linter"),
                    _agent("preset-def-agent-9", "copilot-review", "Copilot Review"),
                    _agent("preset-def-agent-10", "judge", "Judge"),
                ],
            ),
        ],
    },
    # ── App Builder ───────────────────────────────────────────────────
    {
        ...
        "name": "App Builder",
        "description": "Full Spec Kit workflow with Architect agent plus quality, testing, and review",
        "stages": [
            _grouped_stage(
                "preset-ab-stage-1",
                "In progress",
                ...
                "preset-ab-group-1",
                [
                    _agent("preset-ab-agent-1", "speckit.specify", "speckit.specify"),
                    _agent("preset-ab-agent-2", "speckit.plan", "speckit.plan"),
                    _agent("preset-ab-agent-3", "speckit.tasks", "speckit.tasks"),
                    _agent("preset-ab-agent-4", "speckit.analyze", "speckit.analyze"),
                    _agent("preset-ab-agent-5", "speckit.implement", "speckit.implement"),
                    _agent("preset-ab-agent-6", "architect", "Architect"),
                    _agent("preset-ab-agent-7", "quality-assurance", "Quality Assurance"),
                    _agent("preset-ab-agent-8", "tester", "Tester"),
                    _agent("preset-ab-agent-9", "linter", "Linter"),
                    _agent("preset-ab-agent-10", "copilot-review", "Copilot Review"),
                    _agent("preset-ab-agent-11", "judge", "Judge"),
                ],
            ),
        ],
    },
