...
async def _poll_single_project(
    ...
    all_tasks = await _cp.github_service.get_project_items(access_token, project_id)
...
async def _poll_loop(
    ...
    while _polling_state.is_running:
        ...
        try:
            ...
            _cp.github_service.clear_cycle_cache()
            ...
            try:
                ...
                rl_info = _cp.github_service.get_last_rate_limit()
                if (
                    rl_info
        ...
        try:
            ...
            _rl_data = _cp.github_service.get_last_rate_limit()
        ...
        try:
            ...
            _rl_snap = _cp.github_service.get_last_rate_limit()
            if (
                _rl_snap
    ...
    try:
        while True:
            ...
            try:
                ...
                all_tasks = await _cp.github_service.get_project_items(
