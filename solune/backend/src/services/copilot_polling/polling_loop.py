...
async def _poll_loop(
    ...
    while _polling_state.is_running:
        ...
        try:
            ...
            logger.debug("OTel metrics update failed (best-effort)", exc_info=True)
        ...
        except Exception as snap_err:  # noqa: BLE001 — reason: polling resilience; logs and continues
