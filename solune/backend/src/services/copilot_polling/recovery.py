...
async def _escalate_exhausted_recovery(
    ...
    except Exception as exc:  # noqa: BLE001 — reason: polling resilience; logs and continues
        logger.warning(
    ...
    except Exception as alert_err:  # noqa: BLE001 — reason: polling resilience; logs and continues
...
async def _check_copilot_session_health(
    ...
    try:
        ...
        return not errored  # noqa: TRY300 — reason: return in try block; acceptable for this pattern
    ...
    try:
        ...
        for task in active_tasks:
            ...
            if active_step is None and pending_step is None:
                ...
                except Exception as trans_err:  # noqa: BLE001 — reason: polling resilience; logs and continues
                    logger.error(
            ...
            if main_branch_info:
                ...
                if merged_child and merged_child.get("is_merged"):
                    ...
                    except Exception as marker_err:  # noqa: BLE001 — reason: polling resilience; logs and continues
                        logger.warning(
