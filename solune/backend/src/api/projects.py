...
# Maximum consecutive stale cache reads before forcing a fresh API fetch.
# At 30s refresh intervals this produces ~1 forced fetch per 10 minutes on idle boards.
