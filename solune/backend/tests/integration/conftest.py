...
async def thin_mock_client(
    ...
    with ExitStack() as stack:
        ...
        stack.enter_context(patch("src.api.chat.persistence.get_db", return_value=db))
        ...
        stack.enter_context(patch("src.api.chat.persistence._trigger_signal_delivery", lambda *_a, **_k: None))
        stack.enter_context(
            patch(
