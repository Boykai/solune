...
class TestGetPollingStatus:
    ...
    def test_default_state(self):
        with (
            ...
            mock_cp.github_service.get_last_rate_limit.return_value = None
...
class TestPollAppPipeline:
    ...
    async def test_runs_all_steps_including_expensive(self):
        ...
        with (
            ...
            mock_cp.github_service.get_project_items = AsyncMock(return_value=[])
            mock_cp.github_service.clear_cycle_cache = MagicMock()
