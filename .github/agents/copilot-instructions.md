...
- Python 3.12+ (`/home/runner/work/solune/solune/solune/backend/pyproject.toml`), TypeScript ~6.0.2 + React 19.2 (`/home/runner/work/solune/solune/solune/frontend/package.json`) + FastAPI, `sse-starlette`, `github-copilot-sdk`, React, Vite, `@tanstack/react-query`, Tailwind CSS, Vitest (003-ux-fixes)
- SQLite-backed backend state plus existing in-memory React UI state for scroll/streaming buffers (003-ux-fixes)
...
## Recent Changes
- 003-ux-fixes: Added Python 3.12+ (`/home/runner/work/solune/solune/solune/backend/pyproject.toml`), TypeScript ~6.0.2 + React 19.2 (`/home/runner/work/solune/solune/solune/frontend/package.json`) + FastAPI, `sse-starlette`, `github-copilot-sdk`, React, Vite, `@tanstack/react-query`, Tailwind CSS, Vitest
