...
- Python ≥3.12 (backend), TypeScript ~6.0.2 (frontend) + FastAPI, githubkit, azure-ai-inference, agent-framework-core/azure-ai/github-copilot, github-copilot-sdk, opentelemetry-instrumentation-*, @stryker-mutator/core 9.6.x (harden-phase-3)
- SQLite via aiosqlite (no schema changes) (harden-phase-3)
