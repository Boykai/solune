...
- Python 3.12+ (backend); TypeScript/React (frontend) + FastAPI, Pydantic, Vite, Zod (006-remove-fleet-dispatch-cli)
- SQLite via aiosqlite — no schema migration needed (removed fields are safely ignored on deserialization) (006-remove-fleet-dispatch-cli)
