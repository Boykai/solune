...
- Python ≥3.12 (backend), TypeScript 6.0 (frontend) + FastAPI, pytest, pytest-asyncio, httpx, Vitest, React 19.2.0, Playwright (020-remove-skips-fix-bugs)
- SQLite via aiosqlite (backend), localStorage (frontend) (020-remove-skips-fix-bugs)
