...
- Python 3.13 (backend), TypeScript ~6.0 (frontend) + FastAPI, pytest 9.0+, Hypothesis 6.131+ (backend); React 19, Vitest 4.1+, @fast-check/vitest 0.4, Playwright 1.59, @axe-core/playwright 4.10 (frontend) (1240-harden-phase-2)
- N/A (no schema changes — test-only workstream) (1240-harden-phase-2)
