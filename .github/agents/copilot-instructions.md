...
- TypeScript 6.0 (frontend only) + React 19.2.0, Vite, Vitest, Playwright (e2e) (020-update-app-title-hello-world)
- N/A — no data layer changes (020-update-app-title-hello-world)
