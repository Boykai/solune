...
- Python >= 3.12 (backend), TypeScript ~6.0.2 (frontend) + FastAPI >= 0.135.0, Pydantic >= 2.12.0, React 19, Zod (frontend) (002-remove-fleet-dispatch)
- aiosqlite (pipeline state) — no schema migration needed; removed fields are harmlessly ignored (002-remove-fleet-dispatch)
