...
| `pr_number: int \| None` | Present (L43) | Unchanged | Retained — still set by execute_pipeline_launch for tracking |
| `pr_url: str \| None` | Present (L44) | Unchanged | Retained — still set by execute_pipeline_launch for tracking |
