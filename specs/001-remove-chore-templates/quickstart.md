...
# - Replace ~278 lines with execute_pipeline_launch() call
...
# 18. Update MCP tools if needed
# File: solune/backend/src/services/mcp_server/tools/chores.py
# - Replace template_content → description references
